...
@override Widget build(BuildContext context) { return ListView( padding: const EdgeInsets.all(16), children: [ SectionTitle(title: t.programs), const SizedBox(height: 16), GridView.builder( shrinkWrap: true, physics: const NeverScrollableScrollPhysics(), itemCount: trinkPrograms.length, gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount( crossAxisCount: 2, crossAxisSpacing: 12, mainAxisSpacing: 12, childAspectRatio: .95, ), itemBuilder: (context, index) { final p = trinkPrograms[index]; return ProgramCard(program: p); }, ), ], ); } }
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${exercise.category} • ${exercise.calories} kcal',
